...
const PartnersSection = () => {
  ...
  return <div className="container mx-auto px-6 py-0">
      ...
      <div className="relative mx-auto max-w-5xl">
        {limitedPartners.length === 0 ? <div className="text-center py-12">
            <p className="text-xl text-gray-500">لا يوجد شركاء حالياً</p>
          </div> : <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              {limitedPartners.map(partner => <div key={partner.id} className="bg-white border border-trndsky-blue/10 shadow hover:shadow-md transition-all flex flex-col items-center justify-center h-48 p-4 rounded-3xl animate-fade-in">
            ...
            <div className="mt-8 text-center">
              <Link to="/partners">
                <Button variant="outline" className="border-trndsky-blue text-trndsky-blue hover:bg-trndsky-blue/10 font-tajawal">
                  عرض جميع الشركاء
