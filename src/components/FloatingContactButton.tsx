      ...
      <AnimatePresence>
        ...
        scale: 0.9
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="w-full bg-trndsky-blue hover:bg-trndsky-darkblue text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center gap-2 transition-all duration-300 shadow-blue-glow font-tajawal">
        ...
        scale: 0.95
      }} onClick={() => setIsOpen(true)} aria-label="التواصل معنا" className="bg-trndsky-blue text-white rounded-full p-4 shadow-xl hover:shadow-2xl flex items-center justify-center transition-all duration-300 border-2 border-white my-[101px] mx-0 py-[12px] px-[18px]">
