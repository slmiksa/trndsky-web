    ...
    <div className="min-h-screen flex flex-col custom-scrollbar">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-br from-gray-50 to-gray-100 py-12">
          <div className="container mx-auto animate-on-scroll opacity-0 transition-all duration-700 translate-y-10">
            <TechIcons />
          </div>
        </section>
        ...
        <section className="section-padding bg-gradient-to-br from-trndsky-blue/5 to-trndsky-teal/5">
          <div className="container mx-auto animate-on-scroll opacity-0 transition-all duration-700 translate-y-10">
            <div className="text-center mb-12">
      ...
      <footer className="bg-trndsky-darkblue text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="animate-on-scroll opacity-0 transition-all duration-700 translate-y-10">
              ...
              <div className="flex space-x-4 rtl:space-x-reverse">
                ...
                <a href="#" className="text-white hover:text-trndsky-teal transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" clipRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.045-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 015.45 2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 11.685 2h.63z"></path><path fillRule="evenodd" clipRule="evenodd" d="M12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z"></path>
                  </svg>
                </a>
              </div>
            </div>
            
            <div className="animate-on-scroll opacity-0 transition-all duration-700 translate-y-10 delay-100">
            ...
            <div className="animate-on-scroll opacity-0 transition-all duration-700 translate-y-10 delay-200">
